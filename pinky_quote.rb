class PinkyQuote
  ...
  def self.all_quotes
    ...
    @@all_quotes ||= [
      ...
      "Well, I think so but where do you stick the feather and call it macaroni?",
      ...
      "Narf! I think so, Brain, but what if the Telechubbies don\'t fight fair?",
